...
public class BuyCardDetailsFragment extends BaseFragment {
    private RecyclerView rvBuyCardDetails;
    ...
    private void setRecyclerView() {
        rvBuyCardDetails.setLayoutManager(new LinearLayoutManager(context));
        rvBuyCardDetails.setAdapter(new ExpensesAdapter(context, mList));
    }
    ...
    private void findViews() {
        rvBuyCardDetails = getView().findViewById(R.id.recycler_view);
    }
}

...
public class MyRedEnvelopeAdapter extends RecyclerView.Adapter<MyRedEnvelopeAdapter.ViewHolder> {

    private final List<AllowanceBean> mList;
    private final Context mContext;

    public MyRedEnvelopeAdapter(Context context, List<AllowanceBean> mList) {

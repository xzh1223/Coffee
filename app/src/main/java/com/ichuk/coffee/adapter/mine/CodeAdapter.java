...
public class CodeAdapter extends RecyclerView.Adapter<CodeAdapter.ViewHolder> {
    ...
    public CodeAdapter(Context mContext, List<String> codeList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(View.inflate(mContext, R.layout.item_rv_code, null));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (codeStr != null) {
            holder.tvNum.setText("取杯码" + (position + 1) + ":");

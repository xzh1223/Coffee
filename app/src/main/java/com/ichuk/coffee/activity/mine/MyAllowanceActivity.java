...
import com.ichuk.coffee.adapter.mine.MyAllowanceAdapter;
...
public class MyAllowanceActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void setEvent() {
        tvHeaderTitle.setText(getResources().getString(R.string.my_allowance));
    ...
    private void setRecyclerView() {
        ...
        mAdapter = new MyAllowanceAdapter(context, mList);
    ...
    private void getData(int position) {
        ...
        switch (position) {
            case 0: {
                ...
                allowanceBean.setLimit("全部商品可用");
                allowanceBean.setTitle("苏州工业园区月亮湾商业广场优惠券");
